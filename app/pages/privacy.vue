      ...
      <div class="max-w-3xl mx-auto text-left space-y-12">
        ...
        <div class="space-y-4">
          <h2 class="text-2xl font-semibold text-gray-900 dark:text-white tracking-tight">Personal Data Collection and
            Use</h2>
          <p class="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
            FaFaRunner is an open-source application, and we are dedicated to user privacy. In line with this, we confirm
            that
        ...
        <div class="space-y-4">
          ...
          <p class="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
            As FaFaRunner does not collect any data, there are no concerns regarding the transmission or storage of data.
        ...
        <div class="space-y-4">
          ...
          <p class="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
            While FaFaRunner itself does not collect any personal or non-personal data, it is important to note that
            users may
        ...
        <div class="space-y-4">
          ...
          <p class="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
            ...
            <a href="mailto:support@fafarunner.com"
              class="text-teal-600 dark:text-teal-400 hover:underline">support@fafarunner.com</a>
          </p>
        </div>
