        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 py-12 px-8 relative">
          ...
          <div class="lg:col-span-5 space-y-10 relative">
            ...
            <div v-if="downloadMetadata[selectedOS].binaries.length > 0" class="space-y-4">
              ...
              <a href="https://github.com/fafarunner/fafarunner/releases" target="_blank"
          ...
          <div class="lg:col-span-7 relative">
            ...
            <div v-else
              ...
              <div class="relative z-10 bg-white p-4 rounded-2xl shadow-xl shadow-gray-200/50 dark:shadow-none mb-8">
                <img src="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=https://fafarunner.com/download"
...
const appleStoreUrl = "https://apps.apple.com/us/app/fafarunner/id1661733229";
...
const nix = {
  ...
  commands: [
    ...
    "programs.fafarunner.enable = true;",
    "# Then run",
...
const fallbackUrl = "https://github.com/fafarunner/fafarunner/releases";

function applyLocaleUrl(url: string): string {
  if (locale.value === 'zh-CN') {
    const fileName = url.split('/').pop();
    return `https://d.fafarunner.com/${fileName}`;
  }
  return url;
}
  ...
  return {
    [OS.windows]: {
      ...
      packageManagers: [
        {
          name: "Winget",
          commands: ["winget install fafarunner"],
        },
        {
          name: "Chocolatey",
          commands: ["choco install fafarunner"],
        },
        {
          name: "Scoop",
          commands: ["scoop bucket add extras", "scoop install fafarunner"],
        },
      ],
    },
    [OS.macos]: {
      ...
      packageManagers: [
        {
          name: "Homebrew",
          commands: ["brew install --cask fafarunner"],
        },
      ],
    },
    [OS.linux]: {
      ...
      packageManagers: [
        {
          name: "Flathub",
          commands: [
            "flatpak install flathub com.fafarunner.fafarunner",
        ...
        {
          name: "Snap",
          commands: ["sudo snap install fafarunner"],
        },
        {
          name: "AUR",
          commands: ["yay -S fafarunner-bin"],
        },
      ],
    },
    [OS.android]: {
      stores: [
        `<a href='https://play.google.com/store/apps/details?id=com.fafarunner.fafarunner&pcampaignid=pcampaignidMKT-Other-global-all-co-prtnr-py-PartBadge-Mar2515-1'>
        ...
        `<a href="https://f-droid.org/packages/com.fafarunner.fafarunner">
